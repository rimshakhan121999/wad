...
<div class="wrapper">
            ...
            <div class="row">
                ...
                <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4 mt-3 mt-lg-0">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="c_email" name="c_email" placeholder="Enter your email"  required pattern ="[0-2][0-9]|3[0-1]">
                    </div>
                </div>
 ...
 <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4 mt-3 mt-lg-0">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="c_email" name="c_email" placeholder="Enter your email"  required pattern ="19[5-9][0-9]|200[01]">
                    </div>
                </div>
            </div>
            <div class="row my-3">
