...
<div class="container">
    ...
    <form action="insert_product.php" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="d-sm-none d-md-block col-sm-4 col-md-2 col-lg-2 offset-lg-3"style="...">
        ...
        <div class="row my-3">
<<<<<<< HEAD:project-demo/admin/insert_product.html
            <div class="col-sm-4 col-md-6 col-lg-6"></div>
            <div class="">
...
>>>>>>> remotes/upstream/master:pro/admin/insert_product.php
            </div>
        </div>
    </form>
</div>
